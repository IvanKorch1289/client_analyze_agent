...
async def orchestrator_agent(state: Dict[str, Any]) -> Dict[str, Any]:
    ...
    logger.info(f"Orchestrator: начинаем анализ клиента '{client_name}'", component="orchestrator")
    ...
    logger.info(f"Orchestrator: сформировано {len(search_queries)} поисковых запросов", component="orchestrator")
